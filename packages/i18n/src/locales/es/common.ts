export default {
  ...
  // Queue filters
  allItems: 'Todos',
  successfulItems: 'Exitosos',
  errorItems: 'Errores',

  // Queue messages
  contentWithoutTextLabel: 'Contenido sin texto',
  ...
  errorLoadingSections: 'Error al cargar secciones',
  selectSection: 'Seleccionar una sección',
  loadingSections: 'Cargando secciones...',
  noSectionsFound: 'No se encontraron secciones',
  addHeadingsToPage: 'Añade títulos a tu página para crear secciones',
  topOfPage: 'Inicio de la página',
