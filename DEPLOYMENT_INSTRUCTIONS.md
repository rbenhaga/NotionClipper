...
**Date**: 2025-11-16
**Problèmes Identifiés**: 3 erreurs critiques nécessitant intervention manuelle
...
## ❌ ERREUR 2: Migration 006 - Fonction SQL Existe Déjà
...
## ❌ ERREUR 3: canPerformAction is not a function
...
- [ ] **1. Déployer get-user-profile** (5 min)
  ```bash
  supabase functions deploy get-user-profile
  supabase functions list  # Vérifier
  ```

- [ ] **2. Appliquer Migration 006** (2 min)
  ```bash
...
| Problème | Fichier Modifié | Action Requise |
|----------|----------------|----------------|
| get-user-profile 404 | `supabase/functions/get-user-profile/index.ts` | ✅ Déployer via CLI |
| Migration 006 erreur | `database/migrations/006_create_increment_usage_counter.sql` | ✅ Exécuter SQL |
| canPerformAction missing | `packages/core-shared/src/services/subscription.service.ts` | ✅ Rebuild app |
